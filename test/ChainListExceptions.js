...
contract("ChainList", function(accounts) {
  ...
  it("should throw an exception if you try to buy an article that does not exist", function() {
    return ChainList.deployed().then(function(instance){
      ...
      return chainListInstance.buyArticle(2, {from: seller, value: web3(articlePrice, "ether")});
    }).then(assert.fail)
    .catch(function(error) {
      assert(true);
    }).then(function() {
  ...
  // incorrect value
  it("should throw an exception if you try to buy your own article for a value different from its price", function() {
    return ChainList.deployed().then(function(instance) {
      chainListInstance = instance;
